<template>
	<div class="settings-tab-appearance">
		<div class="settings-section">
			<h2 class="section-title">{{ getString("settings.appearance.themes.title") }}</h2>
			<div class="settings-items">
				<div class="settings-item">
					<label class="settings-label">{{ getString("settings.appearance.themes.title") }}</label>
					<select
...
const themes = [
	{ id: "classic", name: "Meridius Classic" },
	{ id: "vk-black", name: "VK Black" },
	{ id: "vk-white", name: "VK White" }
];
